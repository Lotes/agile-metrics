...
namespace SVGViewer
{
	class TextRender
	{
		static public GeometryGroup BuildTextGeometry(SVGViewer.TextShape shape)
		{
		...
		static GeometryGroup BuildGlyphRun(SVGViewer.TextShape shape, double xoffset, double yoffset)
		{
		...
		static GeometryGroup BuildTextSpan(SVGViewer.TextShape shape)
		{
			double x = shape.X;
			double y = shape.Y;
			GeometryGroup gp = new GeometryGroup();
